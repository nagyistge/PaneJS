...
class NodeView extends CellView {
    ...
    update(specifiedAttrs) {
        ...
        utils.forEach(relativelySelectors, function (selector) {
            ...
            let attrs = specified ? utils.merge({}, all, specified) : all;
