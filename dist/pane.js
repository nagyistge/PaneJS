...
/***/ function(module, exports, __webpack_require__) {
	...
	window.zGraph = module.exports = {
	    Canvas2D: __webpack_require__(39),
	    Cell: __webpack_require__(41),
	    CellRenderer: __webpack_require__(42),
	    CellState: __webpack_require__(55),
	    EventObject: __webpack_require__(14),
	    Geometry: __webpack_require__(56),
	    Graph: __webpack_require__(57),
	    Model: __webpack_require__(66),
	    Point: __webpack_require__(45),
	    Rectangle: __webpack_require__(44),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventObject = __webpack_require__(14);
	...
	var EventSource = Class.create({
	     ...
	     * Sets <eventsEnabled>.
	     */
	    setEventsEnabled: function setEventsEnabled(value) {
	     ...
	     * Sets <eventSource>.
	     */
	    setEventSource: function setEventSource(value) {
	     ...
	     */
	    addListener: function addListener(name, funct) {
	     ...
	     */
	    removeListener: function removeListener(funct) {
	        if (this.eventListeners !== null) {
	            var i = 0;
	     ...
	     */
	    fireEvent: function fireEvent(evt, sender) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Change = __webpack_require__(30);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var proto = {
	    ...
	    rotatePoint: function rotatePoint(x, y, theta, cx, cy) {
	    ...
	    rect: function rect(x, y, w, h, dx, dy) {
	    ...
	    image: function image(x, y, w, h, src, aspect, flipH, flipV) {
	    ...
	    text: function text(x, y, w, h, str, align, valign, wrap, format, overflow, clip, rotation) {
	        ...
	        if (canvas.textEnabled && !isNullOrUndefined(str)) {
	            ...
	            if (canvas.foEnabled && format === 'html') {
	                ...
	                if (state.rotation != 0 && this.rotateHtml) {
	                    ...
	                    var pt = this.rotatePoint((x + w / 2) * state.scale, (y + h / 2) * state.scale, state.rotation, state.rotationCx, state.rotationCy);
	    ...
	    plainText: function plainText(x, y, w, h, str, align, valign, wrap, overflow, clip, rotation) {
	        ...
	        // Default is left
	        var anchor = align == constants.ALIGN_RIGHT ? 'end' : align == constants.ALIGN_CENTER ? 'middle' : 'start';
	    ...
	    createClip: function createClip(x, y, w, h) {
	        x = Math.round(x);
	        y = Math.round(y);
	        w = Math.round(w);
	        h = Math.round(h);
	    ...
	    updateFont: function updateFont(node) {
	    ...
	    addTextBackground: function addTextBackground(node, str, x, y, w, h, align, valign, overflow) {
	        var s = this.state;
	    ...
	    createStyle: function createStyle() {
	        ...
	        utils.write(style, 'svg{font-family:' + constants.DEFAULT_FONTFAMILY + ';font-size:' + constants.DEFAULT_FONTSIZE + ';fill:none;stroke-miterlimit:10}');
	    ...
	    createAlternateContent: function createAlternateContent(fo, x, y, w, h) {
	        if (this.foAltText) {
	    ...
	    getSvgGradient: function getSvgGradient(start, end, alpha1, alpha2, direction) {
	    ...
	    createSvgGradient: function createSvgGradient(start, end, alpha1, alpha2, direction) {
	    ...
	    addNode: function addNode(filled, stroked) {
	        ...
	        // Adds pointer events
	        if (that.pointerEvents && (node.nodeName != 'path' || this.path[this.path.length - 1] == this.closeOp)) {
	    ...
	    updateFill: function updateFill() {
	        var s = this.state;
	    ...
	    getCurrentStrokeWidth: function getCurrentStrokeWidth() {
	    ...
	    updateStrokeAttributes: function updateStrokeAttributes() {
	        var s = this.state;
	    ...
	    createDashPattern: function createDashPattern(scale) {
	        var pat = [];
	    ...
	    setFillColor: function setFillColor(value) {
	        var canvas = this;
	        var state = canvas.state;
	    ...
	    setFontStyle: function setFontStyle(value) {
	        var canvas = this;
	        var state = canvas.state;
	    ...
	    setShadowOffset: function setShadowOffset(dx, dy) {
	        var canvas = this;
	        var state = canvas.state;
	...
	each(['alpha', 'strokeWidth', 'dashed', 'dashPattern', 'lineCap', 'lineJoin', 'miterLimit', 'fontSize', 'fontFamily', 'shadow', 'shadowAlpha'], function (attr) {
	...
	each(['strokeColor', 'fontColor', 'fontBackgroundColor', 'fontBorderColor', 'setShadowColor'], function (attr) {
	    proto['set' + ucFirst(attr)] = function (value) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = Class.create({
	    ...
	    setVertex: function setVertex(vertex) {
	        this.vertex = vertex;
	    },
	    ...
	    setConnectable: function setConnectable(connectable) {
	    ...
	    getTerminal: function getTerminal(source) {
	        return source ? this.source : this.target;
	    },
	
	    setTerminal: function setTerminal(terminal, isSource) {
	        if (isSource) {
	    ...
	    getEdgeCount: function getEdgeCount() {
	        return this.edges === null ? 0 : this.edges.length;
	    },
	
	    getEdgeIndex: function getEdgeIndex(edge) {
	        return utils.indexOf(this.edges, edge);
	    },
	
	    getEdgeAt: function getEdgeAt(index) {
	        return this.edges === null ? null : this.edges[index];
	    },
	
	    insertEdge: function insertEdge(edge, isOutgoing) {
	        if (edge !== null) {
	            edge.removeFromTerminal(isOutgoing);
	            edge.setTerminal(this, isOutgoing);
	
	            if (this.edges === null || edge.getTerminal(!isOutgoing) !== this || utils.indexOf(this.edges, edge) < 0) {
	                if (this.edges === null) {
	                    this.edges = [];
	                }
	    ...
	    removeEdge: function removeEdge(edge, isOutgoing) {
	        if (edge) {
	    ...
	    getAttribute: function getAttribute(name, defaultValue) {
	        ...
	        var val = userObject !== null && userObject.nodeType === constants.NODETYPE_ELEMENT ? userObject.getAttribute(name) : null;
	    ...
	    setAttribute: function setAttribute(name, value) {
	        ...
	        if (userObject !== null && userObject.nodeType === constants.NODETYPE_ELEMENT) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dictionary = __webpack_require__(43);
	var Rectangle = __webpack_require__(44);
	var Point = __webpack_require__(45);
	var constants = __webpack_require__(40);
	
	var Shape = __webpack_require__(46);
	var RectangleShape = __webpack_require__(48);
	var Text = __webpack_require__(49);
	var Connector = __webpack_require__(50);
	
	var MouseEvent = __webpack_require__(53);
	var domEvent = __webpack_require__(54);
	var eventNames = __webpack_require__(28);
	...
	var CellRenderer = Class.create({
	    ...
	    initializeShape: function initializeShape(state) {
	    ...
	    // 获取构造函数
	    getShapeConstructor: function getShapeConstructor(state) {
	    ...
	    postConfigureShape: function postConfigureShape(state) {
	        if (state.shape) {
	    ...
	    resolveColor: function resolveColor(state, field, key) {
	    ...
	    createLabel: function createLabel(state, value) {
	        ...
	        if (state.style[constants.STYLE_FONTSIZE] > 0 || state.style[constants.STYLE_FONTSIZE] == null) {
	            ...
	            state.text = new this.defaultTextShape(value, new Rectangle(), state.style[constants.STYLE_ALIGN] || constants.ALIGN_CENTER, graph.getVerticalAlign(state), state.style[constants.STYLE_FONTCOLOR], state.style[constants.STYLE_FONTFAMILY], state.style[constants.STYLE_FONTSIZE], state.style[constants.STYLE_FONTSTYLE], state.style[constants.STYLE_SPACING], state.style[constants.STYLE_SPACING_TOP], state.style[constants.STYLE_SPACING_RIGHT], state.style[constants.STYLE_SPACING_BOTTOM], state.style[constants.STYLE_SPACING_LEFT], state.style[constants.STYLE_HORIZONTAL], state.style[constants.STYLE_LABEL_BACKGROUNDCOLOR], state.style[constants.STYLE_LABEL_BORDERCOLOR], graph.isWrapping(state.cell) && graph.isHtmlLabel(state.cell), graph.isLabelClipped(state.cell), state.style[constants.STYLE_OVERFLOW], state.style[constants.STYLE_LABEL_PADDING]);
	            ...
	            mxEvent.addGestureListeners(state.text.node, mxUtils.bind(this, function (evt) {
	                if (this.isLabelEvent(state, evt)) {
	                    ...
	                    forceGetCell = graph.dialect != constants.DIALECT_SVG && mxEvent.getSource(evt).nodeName == 'IMG';
	                }
	    ...
	    initializeLabel: function initializeLabel(state) {
	    ...
	    createCellOverlays: function createCellOverlays(state) {
	        var graph = state.view.graph;
	    ...
	    initializeOverlay: function initializeOverlay(state, overlay) {
	        overlay.init(state.view.getOverlayPane());
	    },
	
	    installCellOverlayListeners: function installCellOverlayListeners(state, overlay, shape) {
	        var graph = state.view.graph;
	    ...
	    initControl: function initControl(state, control, handleEvents, clickHandler) {
	        ...
	        var isForceHtml = graph.isHtmlLabel(state.cell) && mxClient.NO_FO && graph.dialect == constants.DIALECT_SVG;
	    ...
	    isShapeEvent: function isShapeEvent(state, evt) {
	        return true;
	    },
	
	    isLabelEvent: function isLabelEvent(state, evt) {
	        return true;
	    },
	    ...
	    installListeners: function installListeners(state) {
	        ...
	        domEvent.onGesture(state.shape.node, function (evt) {
	    ...
	    redrawLabel: function redrawLabel(state, forced) {
	        ...
	        if (state.text != null) {
	            ...
	            if (forced || state.text.value != value || state.text.isWrapping != wrapping || state.text.isClipping != clipping || state.text.scale != state.view.scale || state.text.dialect != dialect || !state.text.bounds.equals(bounds)) {
	    ...
	    getTextScale: function getTextScale(state) {
	    ...
	    rotateLabelBounds: function rotateLabelBounds(state, bounds) {
	        ...
	        if (theta != 0 && state != null && state.view.graph.model.isVertex(state.cell)) {
	            ...
	            if (bounds.x != cx || bounds.y != cy) {
	                ...
	                var pt = Point.getRotatedPoint(new Point(bounds.x, bounds.y), Math.cos(rad), Math.sin(rad), new Point(cx, cy));
	    ...
	    redrawCellOverlays: function redrawCellOverlays(state, forced) {
	            ...
	            state.overlays.visit(function (id, shape) {
	                ...
	                if (!state.view.graph.getModel().isEdge(state.cell)) {
	                    if (state.shape != null && rot != 0) {
	                        ...
	                        var point = Point.getRotatedPoint(new mxPoint(cx, cy), cos, sin, new mxPoint(state.getCenterX(), state.getCenterY()));
	    ...
	    redrawControl: function redrawControl(state, forced) {
	        ...
	        if (state.control != null && image != null) {
	            ...
	            var r = this.legacyControlPosition ? mxUtils.getValue(state.style, constants.STYLE_ROTATION, 0) : state.shape.getTextRotation();
	            var s = state.view.scale;
	    ...
	    insertStateAfter: function insertStateAfter(state, node, htmlNode) {
	    ...
	    getShapesForState: function getShapesForState(state) {
	    ...
	    redrawShape: function redrawShape(state, force, rendering) {
	        ...
	        if (state.shape) {
	            ...
	            if (force || !state.shape.bounds || state.shape.scale != state.view.scale || state.absolutePoints == null && !state.shape.bounds.equals(state) || state.absolutePoints != null && !Point.equalPoints(state.shape.points, state.absolutePoints)) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Class = __webpack_require__(11);
	var utils = __webpack_require__(1);
	var objectIdentity = __webpack_require__(37);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Rectangle = Klass.create({
	    ...
	    Statics: {
	        fromRectangle: function fromRectangle(rect) {
	    ...
	    equals: function equals(rect) {
	        ...
	        return Rectangle.superclass.equals.call(that, rect) && rect instanceof Rectangle && rect.width === that.width && rect.height === that.height;
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Point = Class.create({
	    ...
	    Statics: {
	        equalPoints: function equalPoints(points1, points2) {
	            if (!points1 && points2 || points1 && !points2 || points1 && points2 && points1.length !== points2.length) {
	                return false;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Point = __webpack_require__(45);
	var Rectangle = __webpack_require__(44);
	var Canvas2D = __webpack_require__(39);
	...
	var Shape = Base.extend({
	    ...
	    create: function create(container) {
	        ...
	        return container && container.ownerSVGElement ? document.createElementNS(constants.NS_SVG, 'g') : null;
	    },
	    ...
	    getScreenOffset: function getScreenOffset() {
	        ...
	        var that = this;
	        var strokeWidth = that.stencil && that.stencil.strokewidth !== 'inherit' ? that.stencil.strokewidth : that.strokewidth;
	    ...
	    getArcSize: function getArcSize(w, h) {
	        var f = getValue(this.style, constants.STYLE_ARCSIZE, constants.RECTANGLE_ROUNDING_FACTOR * 100) / 100;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = Shape.extend({
	    ...
	    constructor: function Text(value, bounds, align, valign, color, family, size, fontStyle, spacing, spacingTop, spacingRight, spacingBottom, spacingLeft, horizontal, background, border, wrap, clipped, overflow, labelPadding) {
	    ...
	    isParseVml: function isParseVml() {
	        return false;
	    },
	    ...
	    getSvgScreenOffset: function getSvgScreenOffset() {
	        return 0;
	    },
	    ...
	    configureCanvas: function configureCanvas(c, x, y, w, h) {
	    ...
	    updateVmlContainer: function updateVmlContainer() {
	    ...
	    paint: function paint(c) {
	        ...
	        val = !utils.isNode(this.value) && this.replaceLinefeeds && fmt == 'html' ? val.replace(/\n/g, '<br/>') : val;
	
	        c.text(x, y, w, h, val, this.align, this.valign, this.wrap, fmt, this.overflow, this.clipped, this.getTextRotation());
	    },
	
	    redrawHtmlShape: function redrawHtmlShape() {},
	
	    updateHtmlTransform: function updateHtmlTransform() {},
	
	    updateInnerHtml: function updateInnerHtml(elt) {
	    ...
	    updateHtmlFilter: function updateHtmlFilter() {
	    ...
	    updateSize: function updateSize(node, enableWrap) {
	        var w = Math.round(this.bounds.width / this.scale);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Polyline = __webpack_require__(52);
	var constants = __webpack_require__(40);
	...
	var Connector = module.exports = Polyline.extend({
	    ...
	    createMarker: function createMarker(c, pts, isSource) {
	        var result = null;
	        var n = pts.length;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var marker = {
	    markers: [],
	    addMarker: function addMarker(type, fn) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = Shape.extend({
	    ...
	    paintEdgeShape: function paintEdgeShape(canvas, pts) {
	    ...
	    paintLine: function paintLine(canvas, pts, rounded) {
	    ...
	    paintCurvedLine: function paintCurvedLine(canvas, pts) {
	        canvas.begin();
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = Class.create({
	    ...
	    getGraphX: function getGraphX() {
	        return this.graphX;
	    },
	
	    getGraphY: function getGraphY() {
	        return this.graphY;
	    },
	    ...
	    consume: function consume(preventDefault) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var domEvent = {
	    ...
	    on: (function () {
	        ...
	        var update = function update(element, eventName, callback) {
	    ...
	    off: (function () {
	        var updateListener = function updateListener(element, eventName, callback) {
	    ...
	    onGesture: function onGesture(element, startListener, moveListener, endListener) {
	        if (startListener) {
	    ...
	    offGesture: function offGesture(element, startListener, moveListener, endListener) {
	        if (startListener) {
	    ...
	    redirectMouseEvents: function redirectMouseEvents(node, graph, state, down, move, up, dblClick) {
	        ...
	        domEvent.onGesture(node, function (evt) {
	            if (down !== null) {
	                down(evt);
	    ...
	    onMouseWheel: function onMouseWheel(callback) {
	        if (!callback) {
	            return;
	        }
	    ...
	    isMiddleMouseButton: function isMiddleMouseButton(evt) {
	        return evt.button === (detector.IS_IE && (typeof document.documentMode === 'undefined' || document.documentMode < 9) ? 4 : 1);
	    },
	    ...
	    isPopupTrigger: function isPopupTrigger(evt) {
	        return domEvent.isRightMouseButton(evt) || detector.IS_MAC && domEvent.isControlDown(evt) && !domEvent.isShiftDown(evt) && !domEvent.isMetaDown(evt) && !domEvent.isAltDown(evt);
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = Rectangle.extend({
	    ...
	    // 设置连线起点或终点的位置
	    setAbsoluteTerminalPoint: function setAbsoluteTerminalPoint(point, isSource) {
	        ...
	        if (isSource) {
	            length ? points[0] = point : points.push(point);
	        } else {
	            if (length === 0) {
	                points.push(null);
	                points.push(point);
	    ...
	    setVisibleTerminalState: function setVisibleTerminalState(terminalState, isSource) {
	        if (isSource) {
	    ...
	    getPaintBounds: function getPaintBounds() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CellRenderer = __webpack_require__(42);
	var ChildChange = __webpack_require__(31);
	var Class = __webpack_require__(11);
	var ConnectionConstraint = __webpack_require__(58);
	var ConnectionHandler = __webpack_require__(59);
	var Event = __webpack_require__(64);
	var EventObject = __webpack_require__(14);
	var Geometry = __webpack_require__(56);
	var GeometryChange = __webpack_require__(65);
	var Model = __webpack_require__(66);
	var Point = __webpack_require__(45);
	var Rectangle = __webpack_require__(44);
	var RootChange = __webpack_require__(29);
	var Stylesheet = __webpack_require__(71);
	var TerminalChange = __webpack_require__(68);
	var View = __webpack_require__(73);
	var constants = __webpack_require__(40);
	var edgeStyle = __webpack_require__(74);
	var eventNames = __webpack_require__(28);
	var utils = __webpack_require__(1);
	...
	module.exports = Class.create({
	    ...
	    createConnectionHandler: function createConnectionHandler() {
	        return new ConnectionHandler(this);
	    },
	
	    createSelectionModel: function createSelectionModel() {},
	    ...
	    createCellRenderer: function createCellRenderer() {
	        return new CellRenderer();
	    },
	    createCellEditor: function createCellEditor() {},
	    ...
	    setStylesheet: function setStylesheet(stylesheet) {
	        this.stylesheet = stylesheet;
	    },
	    getSelectionModel: function getSelectionModel() {
	        return this.selectionModel;
	    },
	    setSelectionModel: function setSelectionModel(selectionModel) {
	        this.selectionModel = selectionModel;
	    },
	    getSelectionCellsForChanges: function getSelectionCellsForChanges() {},
	    graphModelChanged: function graphModelChanged(changes) {
	        console.log(changes);
	    ...
	    processChange: function processChange(change) {
	        if (change instanceof RootChange) {} else if (change instanceof ChildChange) {
	    ...
	    insertVertex: function insertVertex(parent, id, value, x, y, width, height, style, relative) {
	        var graph = this;
	        var vertex = graph.createVertex(parent, id, value, x, y, width, height, style, relative);
	        return graph.addCell(vertex, parent);
	    },
	    createVertex: function createVertex(parent, id, value, x, y, width, height, style, relative) {
	    ...
	    insertEdge: function insertEdge(parent, id, value, source, target, style) {
	        var edge = this.createEdge(parent, id, value, source, target, style);
	
	        return this.addEdge(edge, parent, source, target);
	    },
	    createEdge: function createEdge(parent, id, value, source, target, style) {
	    ...
	    addEdge: function addEdge(edge, parent, source, target, index) {
	        ...
	        if (constraint) {
	            ...
	            try {
	                if (constraint == null || constraint.point == null) {
	                    this.setCellStyles(source ? constants.STYLE_EXIT_X : constants.STYLE_ENTRY_X, null, [edge]);
	                    this.setCellStyles(source ? constants.STYLE_EXIT_Y : constants.STYLE_ENTRY_Y, null, [edge]);
	                    this.setCellStyles(source ? constants.STYLE_EXIT_PERIMETER : constants.STYLE_ENTRY_PERIMETER, null, [edge]);
	                } else if (constraint.point != null) {
	                    this.setCellStyles(source ? constants.STYLE_EXIT_X : constants.STYLE_ENTRY_X, constraint.point.x, [edge]);
	                    this.setCellStyles(source ? constants.STYLE_EXIT_Y : constants.STYLE_ENTRY_Y, constraint.point.y, [edge]);
	
	                    // Only writes 0 since 1 is default
	                    if (!constraint.perimeter) {
	                        this.setCellStyles(source ? constants.STYLE_EXIT_PERIMETER : constants.STYLE_ENTRY_PERIMETER, '0', [edge]);
	                    } else {
	                        this.setCellStyles(source ? constants.STYLE_EXIT_PERIMETER : constants.STYLE_ENTRY_PERIMETER, null, [edge]);
	                    }
	                }
	    ...
	    getTerminalForPort: function getTerminalForPort(cell, source) {
	    ...
	    setPortsEnabled: function setPortsEnabled(value) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Cell = __webpack_require__(41);
	var CellMarker = __webpack_require__(60);
	var ConstraintHandler = __webpack_require__(62);
	var EventObject = __webpack_require__(14);
	var EventSource = __webpack_require__(12);
	var Geometry = __webpack_require__(56);
	...
	var ConnectionHandler = EventSource.extend({
	    ...
	    isCreateTarget: function isCreateTarget() {
	        return this.createTarget;
	    },
	
	    setCreateTarget: function setCreateTarget(value) {
	    ...
	    isConnectableCell: function isConnectableCell() /*cell*/{
	        return true;
	    },
	    ...
	    createMarker: function createMarker() {
	        ...
	        marker.getCell = utils.bind(this, function (me, cell) {
	            ...
	            var point = new Point(this.graph.snap(me.getGraphX() / scale) * scale, this.graph.snap(me.getGraphY() / scale) * scale);
	            this.error = null;
	        ...
	        marker.getMarkerColor = utils.bind(this, function () /*evt, state, isValid*/{
	            return this.connectImage === null || this.isConnecting() ? CellMarker.prototype.getMarkerColor.apply(marker, arguments) : null;
	        });
	    ...
	    start: function start(state, x, y, edgeState) {
	        this.previous = state;
	    ...
	    getCellAt: function getCellAt(x, y) {
	    ...
	    isValidSource: function isValidSource(cell /*, me*/) {
	        return this.graph.isValidSource(cell);
	    },
	
	    isValidTarget: function isValidTarget() /*cell*/{
	        return true;
	    },
	
	    validateConnection: function validateConnection(source, target) {
	    ...
	    getConnectImage: function getConnectImage() /*state*/{
	        return this.connectImage;
	    },
	
	    isMoveIconToFrontForState: function isMoveIconToFrontForState(state) {
	    ...
	    createIcons: function createIcons(state) {
	        ...
	        if (image != null && state != null) {
	            ...
	            if (this.isMoveIconToFrontForState(state)) {
	                ...
	                icon.dialect = this.graph.dialect === constants.DIALECT_SVG ? constants.DIALECT_SVG : constants.DIALECT_VML;
	            ...
	            var mouseDown = utils.bind(this, function (evt) {
	                if (!domEvent.isConsumed(evt)) {
	                    this.icon = icon;
	                    this.graph.fireMouseEvent(domEvent.MOUSE_DOWN, new MouseEvent(evt, getState()));
	                }
	            });
	    ...
	    redrawIcons: function redrawIcons(icons, state) {
	    ...
	    getIconPosition: function getIconPosition(icon, state) {
	    ...
	    destroyIcons: function destroyIcons() {
	        if (this.icons != null) {
	    ...
	    isStartEvent: function isStartEvent() /*me*/{
	    ...
	    isImmediateConnectSource: function isImmediateConnectSource(state) {
	        return !this.graph.isCellMovable(state.cell);
	    },
	
	    createEdgeState: function createEdgeState() {
	        return null;
	    },
	
	    isOutlineConnectEvent: function isOutlineConnectEvent(me) {
	        return this.outlineConnect && !domEvent.isShiftDown(me.getEvent()) && (me.isSource(this.marker.highlight.shape) || domEvent.isAltDown(me.getEvent()));
	    },
	
	    updateCurrentState: function updateCurrentState(me, point) {
	    ...
	    convertWaypoint: function convertWaypoint(point) {
	            ...
	            if (this.first != null) {
	                ...
	                if (this.selectedIcon != null) {
	                    ...
	                    if (this.currentState != null && this.targetConnectImage) {
	                        ...
	                        var bounds = new Rectangle(me.getGraphX() + this.connectIconOffset.x, me.getGraphY() + this.connectIconOffset.y, w, h);
	    ...
	    getTargetPerimeterPoint: function getTargetPerimeterPoint(state /*, me*/) {
	        var result = null;
	        var view = state.view;
	        var targetPerimeter = view.getPerimeterFunction(state);
	
	        if (targetPerimeter != null) {
	            var next = this.waypoints != null && this.waypoints.length > 0 ? this.waypoints[this.waypoints.length - 1] : new Point(this.previous.getCenterX(), this.previous.getCenterY());
	    ...
	    getSourcePerimeterPoint: function getSourcePerimeterPoint(state, next /*, me*/) {
	        var result = null;
	        var view = state.view;
	    ...
	    updateIcons: function updateIcons() /*state, icons, me*/{
	        // empty
	    },
	
	    isStopEvent: function isStopEvent(me) {
	        return me.getState() != null;
	    },
	
	    addWaypointForEvent: function addWaypointForEvent(me) {
	     ...
	     * returned.
	     */
	    getEdgeColor: function getEdgeColor(valid) {
	     ...
	     * returned.
	     */
	    getEdgeWidth: function getEdgeWidth(valid) {
	        return valid ? 3 : 1;
	    },
	     ...
	     * released.
	     */
	    connect: function connect(source, target, evt, dropTarget) {
	        if (target != null || this.isCreateTarget() || this.graph.allowDanglingEdges) {
	            ...
	            try {
	                ...
	                if (edge != null) {
	                    ...
	                    this.fireEvent(new EventObject(domEvent.CONNECT, 'cell', edge, 'terminal', target, 'event', evt, 'target', dropTarget, 'terminalInserted', terminalInserted));
	                }
	            } catch (e) {
	    ...
	    selectCells: function selectCells(edge /*, target*/) {
	    ...
	    createTargetVertex: function createTargetVertex(evt, source) {
	    ...
	    getAlignmentTolerance: function getAlignmentTolerance() /*evt*/{
	        return this.graph.isGridEnabled() ? this.graph.gridSize / 2 : this.graph.tolerance;
	    },
	
	    createEdge: function createEdge(value, source, target, style) {
	        var edge = null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var domEvent = __webpack_require__(54);
	var constants = __webpack_require__(40);
	var CellHighlight = __webpack_require__(61);
	var EventSource = __webpack_require__(12);
	//var utils = require('../common/utils');
	var Rectangle = __webpack_require__(44);
	...
	var CellMarker = EventSource.extend({
	    ...
	    setHotspot: function setHotspot(hotspot) {
	        this.hotspot = hotspot;
	    },
	
	    getHotspot: function getHotspot() {
	        return this.hotspot;
	    },
	
	    setHotspotEnabled: function setHotspotEnabled(enabled) {
	        this.hotspotEnabled = enabled;
	    },
	
	    isHotspotEnabled: function isHotspotEnabled() {
	        return this.hotspotEnabled;
	    },
	
	    hasValidState: function hasValidState() {
	        return this.validState !== null;
	    },
	
	    getValidState: function getValidState() {
	        return this.validState;
	    },
	
	    getMarkedState: function getMarkedState() {
	    ...
	    setCurrentState: function setCurrentState(state, me, color) {
	    ...
	    markCell: function markCell(cell, color) {
	    ...
	    getMarkerColor: function getMarkerColor(evt, state, isValid) {
	        return isValid ? this.validColor : this.invalidColor;
	    },
	
	    getState: function getState(me) {
	        var view = this.graph.getView();
	    ...
	    getCell: function getCell(me) {
	        return me.getCell();
	    },
	
	    getStateToMark: function getStateToMark(state) {
	        return state;
	    },
	
	    intersects: function intersects(state, me) {
	        if (this.hotspotEnabled) {
	            return Rectangle.intersectsHotspot(state, me.getGraphX(), me.getGraphY(), this.hotspot, constants.MIN_HOTSPOT_SIZE, constants.MAX_HOTSPOT_SIZE);
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CellHighlight = Class.create({
	    ...
	    setHighlightColor: function setHighlightColor(color) {
	    ...
	    drawHighlight: function drawHighlight() {
	        this.shape = this.createShape();
	        this.repaint();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ConstraintHandler = Class.create({
	    ...
	    getTolerance: function getTolerance() /*me*/{
	        return this.graph.getTolerance();
	    },
	
	    getImageForConstraint: function getImageForConstraint() /*state, constraint, point*/{
	        return this.pointImage;
	    },
	
	    isEventIgnored: function isEventIgnored() /*me, source*/{
	        return false;
	    },
	
	    isStateIgnored: function isStateIgnored() /*state, source*/{
	        return false;
	    },
	    ...
	    destroyFocusHighlight: function destroyFocusHighlight() {
	        if (this.focusHighlight != null) {
	            this.focusHighlight.destroy();
	            this.focusHighlight = null;
	        }
	    ...
	    isKeepFocusEvent: function isKeepFocusEvent(me) {
	        return domEvent.isShiftDown(me.getEvent());
	    },
	
	    update: function update(me, source) {
	        if (this.isEnabled() && !this.isEventIgnored(me)) {
	            var tol = this.getTolerance(me);
	            var mouse = new Rectangle(me.getGraphX() - tol, me.getGraphY() - tol, 2 * tol, 2 * tol);
	            var cst = me.getState() != null && !this.isStateIgnored(me.getState(), source) ? this.graph.getAllConnectionConstraints(me.getState(), source) : null;
	
	            // Keeps focus icons visible while over vertex bounds and no other cell under mouse or shift is pressed
	            if (!this.isKeepFocusEvent(me) && (this.currentFocusArea === null || this.currentFocus === null || me.getState() != null && cst != null || !this.graph.getModel().isVertex(this.currentFocus.cell) || !utils.intersects(this.currentFocusArea, mouse)) && (me.getState() != this.currentFocus && (me.getCell() === null || this.graph.isCellConnectable(me.getCell())))) {
	                this.currentFocusArea = null;
	                this.currentFocus = null;
	                ...
	                if (this.constraints != null) {
	                    ...
	                    for (var j = 0; j < this.constraints.length; j++) {
	                        ...
	                        var src = img.src;
	                        var bounds = new Rectangle(cp.x - img.width / 2, cp.y - img.height / 2, img.width, img.height);
	                        var icon = new ImageShape(bounds, src);
	                        icon.dialect = this.graph.dialect != constants.DIALECT_SVG ? constants.DIALECT_MIXEDHTML : constants.DIALECT_SVG;
	                        icon.preserveImageAspect = false;
	                ...
	                for (var k = 0; k < this.focusIcons.length; k++) {
	                    ...
	                    if (utils.intersects(this.focusIcons[k].bounds, mouse) && (minDistSq === null || tmp < minDistSq)) {
	                        ...
	                        if (this.focusHighlight === null) {
	                            ...
	                            hl.dialect = this.graph.dialect === constants.DIALECT_SVG ? constants.DIALECT_SVG : constants.DIALECT_VML;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = Class.create({
	    ...
	    isEventEnabled: function isEventEnabled() {
	        return this.eventEnabled;
	    },
	
	    setIsEventEnabled: function setIsEventEnabled(enabled) {
	        var that = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = Change.extend({
	    ...
	    digest: function digest() {
	        ...
	        change.previous = change.model.geometryForCellChanged(change.cell, change.previous);
	        return change;
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventObject = __webpack_require__(14);
	var RootChange = __webpack_require__(29);
	var StyleChange = __webpack_require__(67);
	var TerminalChange = __webpack_require__(68);
	var UndoableEdit = __webpack_require__(69);
	var utils = __webpack_require__(1);
	var Point = __webpack_require__(45);
	var cellPath = __webpack_require__(70);
	...
	module.exports = Class.create({
	    ...
	    filterCells: function filterCells(cells, filter) {
	        var result = [];
	    ...
	    filterDescendants: function filterDescendants(filter, parent) {
	    ...
	    rootChanged: function rootChanged(root) {
	    ...
	    isCreateIds: function isCreateIds() {
	        return this.createIds;
	    },
	
	    setCreateIds: function setCreateIds(value) {
	    ...
	    updateEdgeParent: function updateEdgeParent(edge, root) {
	        ...
	        while (sourceNode && !this.isEdge(sourceNode) && sourceNode.geometry && sourceNode.geometry.relative) {
	            sourceNode = this.getParent(sourceNode);
	        }
	
	        // Uses the first non-relative descendants of the target terminal
	        while (targetNode && !this.isEdge(targetNode) && targetNode.geometry && targetNode.geometry.relative) {
	    ...
	    // 更新 cell 的 parent
	    parentForCellChanged: function parentForCellChanged(cell, parent, index) {
	    ...
	    getChildCount: function getChildCount(cell) {
	        return cell ? cell.getChildCount() : 0;
	    },
	    getChildAt: function getChildAt(cell, index) {
	        return cell ? cell.getChildAt(index) : null;
	    },
	    getChildren: function getChildren(cell) {
	        return cell ? cell.children : null;
	    },
	    eachChildren: function eachChildren(cell, iterator) {
	        each(cell ? cell.children : [], iterator);
	    },
	    getChildVertices: function getChildVertices(parent) {
	        return this.getChildCells(parent, true, false);
	    },
	    getChildEdges: function getChildEdges(parent) {
	        return this.getChildCells(parent, false, true);
	    },
	    getChildCells: function getChildCells(parent, isVertice, isEdge) {
	        ...
	        for (var i = 0; i < childCount; i++) {
	            ...
	            if (!isEdge && !isVertice || isEdge && this.isEdge(child) || isVertice && this.isVertex(child)) {
	                result.push(child);
	            }
	        }
	    ...
	    getTerminal: function getTerminal(edge, isSource) {
	        return edge ? edge.getTerminal(isSource) : null;
	    },
	    setTerminal: function setTerminal(edge, terminal, isSource) {
	    ...
	    setTerminals: function setTerminals(edge, source, target) {
	        // 设置连线的源和目标
	        this.beginUpdate();
	        try {
	    ...
	    // 连线的起点节点或终点节点改变后
	    terminalForCellChanged: function terminalForCellChanged(edge, cell, isSource) {
	    ...
	    getEdgeCount: function getEdgeCount(cell) {
	        return cell ? cell.getEdgeCount() : 0;
	    },
	
	    getEdgeAt: function getEdgeAt(cell, index) {
	        return cell ? cell.getEdgeAt(index) : null;
	    },
	
	    // 获取直接连接的连线的数量
	    getDirectedEdgeCount: function getDirectedEdgeCount(cell, outgoing, ignoredEdge) {
	        var count = 0;
	        var edgeCount = this.getEdgeCount(cell);
	    ...
	    getIncomingEdges: function getIncomingEdges(cell) {},
	
	    getOutgoingEdges: function getOutgoingEdges(cell) {},
	
	    getEdges: function getEdges(cell, incoming, outgoing, includeLoops) {},
	
	    getEdgesBetween: function getEdgesBetween(source, target, directed) {},
	
	    getOpposites: function getOpposites(edges, terminal, sources, targets) {},
	
	    getTopmostCells: function getTopmostCells(cells) {},
	
	    isVertex: function isVertex(cell) {
	        return cell ? cell.isVertex() : false;
	    },
	
	    isEdge: function isEdge(cell) {
	        return cell ? cell.isEdge() : false;
	    },
	
	    isConnectable: function isConnectable(cell) {
	    ...
	    valueForCellChanged: function valueForCellChanged(cell, value) {},
	    ...
	    geometryForCellChanged: function geometryForCellChanged(cell, geometry) {},
	    ...
	    styleForCellChanged: function styleForCellChanged(cell, style) {
	    ...
	    visibleStateForCellChanged: function visibleStateForCellChanged(cell, visible) {},
	
	    execute: function execute(change) {
	    ...
	    createUndoableEdit: function createUndoableEdit() {
	    ...
	    mergeChildren: function mergeChildren(from, to, cloneAllEdges) {},
	
	    mergeChildrenImpl: function mergeChildrenImpl(from, to, cloneAllEdges, mapping) {},
	
	    getParents: function getParents(cell) {},
	
	    cloneCell: function cloneCell(cell) {},
	
	    cloneCells: function cloneCells(cell, includeChildren) {},
	
	    cloneCellImpl: function cloneCellImpl(cell, mapping, includeChildren) {},
	
	    cellCloned: function cellCloned(cell) {},
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = Class.create({
	    ...
	    isSignificant: function isSignificant() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var utils = __webpack_require__(1);
	var constants = __webpack_require__(40);
	var perimeter = __webpack_require__(72);
	...
	module.exports = Class.create({
	    ...
	    createDefaultVertexStyle: function createDefaultVertexStyle() {
	        var style = {};
	    ...
	    createDefaultEdgeStyle: function createDefaultEdgeStyle() {
	        var style = {};
	    ...
	    putDefaultVertexStyle: function putDefaultVertexStyle(style) {
	        this.putCellStyle('defaultVertex', style);
	    },
	
	    putDefaultEdgeStyle: function putDefaultEdgeStyle(style) {
	        this.putCellStyle('defaultEdge', style);
	    },
	
	    getDefaultVertexStyle: function getDefaultVertexStyle() {
	        return this.styles['defaultVertex'];
	    },
	
	    getDefaultEdgeStyle: function getDefaultEdgeStyle() {
	        return this.styles['defaultEdge'];
	    },
	
	    putCellStyle: function putCellStyle(name, style) {
	        this.styles[name] = style;
	    },
	
	    getCellStyle: function getCellStyle(name, defaultStyle) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Point = __webpack_require__(45);
	var Rectangle = __webpack_require__(44);
	var CellState = __webpack_require__(55);
	var MouseEvent = __webpack_require__(53);
	var domEvent = __webpack_require__(54);
	var eventNames = __webpack_require__(28);
	...
	module.exports = Class.create({
	    ...
	    setGraphBounds: function setGraphBounds(value) {
	        this.graphBounds = value;
	    },
	
	    getBounds: function getBounds(cells) {
	    ...
	    setCurrentRoot: function setCurrentRoot(root) {
	    ...
	    scaleAndTranslate: function scaleAndTranslate(scale, dx, dy) {
	        ...
	        that.fireEvent(new EventObject(mxEvent.SCALE_AND_TRANSLATE, 'scale', scale, 'previousScale', previousScale, 'translate', that.translate, 'previousTranslate', previousTranslate));
	    },
	    ...
	    setTranslate: function setTranslate(dx, dy) {
	    ...
	    invalidate: function invalidate(cell, recurse, includeEdges) {
	    ...
	    getBoundingBox: function getBoundingBox(state, recurse) {
	    ...
	    validateBackgroundImage: function validateBackgroundImage() {
	        ...
	        if (bg) {
	            if (this.backgroundImage == null || this.backgroundImage.image != bg.src) {
	                ...
	                if (document.documentMode == 8 && !mxClient.IS_EM) {
	                    mxEvent.addGestureListeners(this.backgroundImage.node, utils.bind(this, function (evt) {
	    ...
	    updateVertexState: function updateVertexState(state, geo) {
	        var model = this.graph.getModel();
	        var pState = this.getState(model.getParent(state.cell));
	    ...
	    updateEdgeState: function updateEdgeState(linkState, geo) {
	        ...
	        if (this.graph.model.getTerminal(linkState.cell, true) && sourceState == null || sourceState == null && geo.getTerminalPoint(true) == null || this.graph.model.getTerminal(linkState.cell, false) && targetState == null || targetState == null && geo.getTerminalPoint(false) == null) {
	            ...
	            if (linkState.cell != this.currentRoot && (pts == null || pts.length < 2 || pts[0] == null || pts[pts.length - 1] == null)) {
	    ...
	    updateVertexLabelOffset: function updateVertexLabelOffset(state) {
	    ...
	    updateFixedTerminalPoint: function updateFixedTerminalPoint(linkState, terminalState, isSource, constraint) {
	        ...
	        if (pt == null && terminalState == null) {
	            ...
	            if (pt != null) {
	                pt = new Point(scale * (translate.x + pt.x + origin.x), scale * (translate.y + pt.y + origin.y));
	            }
	        }
	    ...
	    getEdgeStyle: function getEdgeStyle(linkState, points, sourceState, targetState) {
	        var edgeStyle = sourceState && sourceState === targetState ? getValue(linkState.style, constants.STYLE_LOOP, this.graph.defaultLoopStyle) : !getValue(linkState.style, constants.STYLE_NOEDGESTYLE, false) ? linkState.style[constants.STYLE_EDGE] : null;
	    ...
	    // 获取连线与节点的连接点
	    updateFloatingTerminalPoint: function updateFloatingTerminalPoint(linkState, start, end, isSource) {
	        ...
	        border += parseFloat(linkState.style[isSource ? constants.STYLE_SOURCE_PERIMETER_SPACING : constants.STYLE_TARGET_PERIMETER_SPACING] || 0);
	    ...
	    getTerminalPort: function getTerminalPort(linkState, terminalState, isSource) {
	    ...
	    setRendering: function setRendering(value) {
	        this.rendering = value;
	    },
	
	    isAllowEval: function isAllowEval() {
	        return this.allowEval;
	    },
	
	    setAllowEval: function setAllowEval(value) {
	    ...
	    getCellStates: function getCellStates(cells) {
	    ...
	    getBackgroundPane: function getBackgroundPane() {
	        return this.backgroundPane;
	    },
	
	    getDrawPane: function getDrawPane() {
	        return this.drawPane;
	    },
	
	    getOverlayPane: function getOverlayPane() {
	        return this.overlayPane;
	    },
	
	    getDecoratorPane: function getDecoratorPane() {
	    ...
	    isContainerEvent: function isContainerEvent(evt) {
	        ...
	        return source === that.graph.container || source.parentNode == that.backgroundPane || source.parentNode && source.parentNode.parentNode === that.backgroundPane || source === that.canvas.parentNode || source === that.canvas || source === that.backgroundPane || source === that.drawPane || source === that.overlayPane || source === that.decoratorPane;
	    },
	    ...
	    installListeners: function installListeners() {
	        ...
	        if (container) {
	            ...
	            domEvent.onGesture(container, function (evt) {
	                // Condition to avoid scrollbar events starting a rubberband selection
	                if (that.isContainerEvent(evt) && (!detector.IS_IE && !detector.IS_IE11 && !detector.IS_GC && !detector.IS_OP && !detector.IS_SF || !that.isScrollEvent(evt))) {
