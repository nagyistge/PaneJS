...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Paper2 = __webpack_require__(31);
	...
	var VElement = exports.VElement = (function () {
	    ...
	    _createClass(VElement, [{
	        ...
	        value: function findIntersection(ref, target) {
	            ...
	            var bbox = _Rect2.default.fromRect(that.bbox(false, target));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Visual2 = __webpack_require__(17);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _normal = __webpack_require__(23);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RootChange = __webpack_require__(26);
	
	var _RootChange2 = _interopRequireDefault(_RootChange);
	
	var _ChildChange = __webpack_require__(27);
	...
	var _ChangeCollection = __webpack_require__(30);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _detector = __webpack_require__(32);
	...
	var _LinkView = __webpack_require__(21);
	
	var _LinkView2 = _interopRequireDefault(_LinkView);
	
	var _NodeView = __webpack_require__(24);
	...
	var Paper = (function (_Events) {
	    ...
	    _createClass(Paper, [{
	        ...
	        value: function getConnectionPoint(link, isSource) {
	            ...
	            var spot = undefined;
	            var terminal = model.getTerminal(link, isSource);
	            ...
	            if (terminal) {
	                ...
	                if (!reference) {
	                    ...
	                    var referenceTerminal = link.getTerminal(!isSource);
	
	                    if (referenceTerminal) {
	
	                        var referenceBBox = new _Rect2.default(referenceTerminal.position.x, referenceTerminal.position.y, referenceTerminal.size.width, referenceTerminal.size.height);
	        ...
	        key: 'getRouterByName',
	        value: function getRouterByName(name) {}
